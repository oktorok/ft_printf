...
/*   Updated: 2018/01/29 22:36:23 by jagarcia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const char	g_types[26] = {"sScCidDoOuUxXpebEfFgGaAnrk"};
static const char	g_length_modifiers[6][8] = {{"di"},{"ouxX"},{"n"},
	{"aAeEfFgG"},{"cs"}};
static char		*(*type_function [16])(char *, va_list, va_list) =
{ft_s_type, ft_ws_type, ft_c_type, ft_wc_type, ft_id_type, ft_id_type,
 ...
 ft_x_type, ft_lx_type, ft_p_type, ft_e_type, ft_b_type};
